...
parser.add_argument('-o', '--out', type=str, dest='outFound', required=True, help='Save Wallet Details in this file / Example: python3 -r richListFile.txt -o FoundPkeys.txt')
